...
mpg %>% 
  ggplot(aes(displ, hwy)) +
  geom_point(aes(color = class)) +
  stat_ellipse(data = . %>% filter(class == "2seater"), geom = "polygon", alpha = 0.2)
```
...
1. Map multiple aesthetics to multiple variables
...
https://ggplot2.tidyverse.org/reference/theme.html#examples


---
## Effective Visualization

[Designing effective visualizations](https://introds.org/slides/w4_d1-effective-dataviz/w4_d1-effective-dataviz.html#26)  From Dr. Mine Çetinkaya-Rundel - _Introduction to Data Science_ https://introds.org
